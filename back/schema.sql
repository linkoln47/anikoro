-- Development bootstrap schema.
--
-- This file is not an incremental migration history. It assumes a freshly
-- created or reset database and defines the current desired schema only.
-- During the current development flow, schema changes are applied by dropping
-- and recreating the database, then running this file again.
