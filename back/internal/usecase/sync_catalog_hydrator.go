...
func (hydrator *SyncCatalogHydrator) hydrateCatalogGraphWithResolverFactory(
	ctx context.Context,
	seedIDs []int,
	cache ports.AnimeDetailsCacheStore,
	job ports.SyncProgressReporter,
	newResolver func(context.Context) (*syncCatalogResolver, error),
) error {
